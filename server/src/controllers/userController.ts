...
import { UserRequest, UserResponse, UserType } from '../types/index';
...
export const showCurrentUser = async (req: UserRequest, res: UserResponse) => {
  const user = req.user;
  // Exclude the refreshToken property before sending the response
